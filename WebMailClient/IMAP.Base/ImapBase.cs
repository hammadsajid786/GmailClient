...
namespace IMAP.Base
{
    ...
    public class ImapBase : TextClient, IImapBase
    {
        ...
        public ImapBase(string host, string username, string password, AuthMethods method = AuthMethods.Login, int port = 143, bool secure = false, bool skipSslValidation = false)
            :this()
        {
        ...
        public virtual Mailbox Examine(string mailboxName)
        {
            IdlePause();
        ...
        public virtual int GetTotalMessages()
        {
            CheckMailboxSelected();
            return GetTotalMessages(null);
        }
        public virtual int GetTotalMessages(string mailbox)
        {
            IdlePause();
        ...
        protected virtual string HandleUntaggedResponse(string response, Mailbox mailbox)
        {
            Match match;
            while (response.StartsWith("*"))
            {
